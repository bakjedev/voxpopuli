...
built on [jbikker/voxpopuli](https://github.com/jbikker/voxpopuli)
...
Move your mouse close to a light and hold space. You can now move your mouse and the light will move with it. It will not be able to move through walls.

debug controls:
R = shoot test ray with debug drawing
T = clear debug lines
Y = set active material
U = send a trace and get the result
I = toggle debug hud

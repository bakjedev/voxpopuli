...
static const float RECIPROCAL_2_32 = 1.0f / (static_cast<float>(1ULL << 32));
...
// [0..1)
float RandomFloat() { return RandomUInt() * RECIPROCAL_2_32; }
...
float RandomFloat( uint& customSeed ) { return RandomUInt( customSeed ) * RECIPROCAL_2_32; }
...
float3 mix( const float3& a, const float3& b, const float t )
{
	return a * (1.0f - t) + b * t;
}
